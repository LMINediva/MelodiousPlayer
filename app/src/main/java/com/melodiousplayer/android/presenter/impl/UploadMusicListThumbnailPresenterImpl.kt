...
import com.melodiousplayer.android.net.UploadMusicListThumbnailRequest
import java.io.File

class UploadMusicListThumbnailPresenterImpl(val view: UploadThumbnailContract.View) :
    ...
    override fun uploadThumbnail(token: String, file: File) {
        UploadMusicListThumbnailRequest(this).executePostUploadFile(token, "image/jpeg", file,
